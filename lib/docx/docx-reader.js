    ...
    return readPackageRelationships(docxFile).then(function(packageRelationships) {
        ...
        return xmlFileReader({
            ...
            return {
                ...
                headers: findPartsByType(documentRelationships, "header"),
                footers: findPartsByType(documentRelationships, "footer")
            };
        });
    });
}

function findPartsByType(relationships, type) {
    var relationshipType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/" + type;
    return relationships.findTargetsByType(relationshipType);
}
