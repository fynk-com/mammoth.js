...
function BodyReader(options) {
    ...
    function extractShapeDimensions(style) {
      ...
      while ((match = dimensionPattern.exec(style)) !== null) {
          ...
          dimensions[property] = convertToPixels(rawValue, unit)?.pixels;
      }
    ...
    function readBlip(element, blip) {
      ...
      var width = widthRaw ? convertToPixels(widthRaw, unitType)?.pixels : null;
      var height = heightRaw ? convertToPixels(heightRaw, unitType)?.pixels : null;
