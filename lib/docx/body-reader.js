...
function readNumberingProperties(styleId, element, numbering) {
    ...
    console.log('readNumberingProperties level', level);
    console.log('readNumberingProperties numId', numId);
    console.log(numbering);
    if (level !== undefined && numId !== undefined) {
        console.log('readNumberingProperties findLevel', numbering.findLevel(numId, level));
