...
function readNumberingProperties(styleId, element, numbering) {
    console.log('readNumberingProperties styleId', styleId);
    console.log('readNumberingProperties element', element);
    console.log('readNumberingProperties numbering', numbering);
